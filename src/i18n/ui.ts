...
export const ui = {
  pt: {
    ...
    calculator: {
      tag: '[CALCULADORA DE DESPERDÍCIO OPERACIONAL]',
      title: 'Calculadora de Fricção & Desperdício PME',
      desc: 'Estime o impacto financeiro e as horas consumidas por processos manuais redundantes e estrangulamentos operacionais na sua empresa.',
      teamSizeLabel: 'Dimensão da Equipa',
      teamSizeUnit: 'colaboradores',
      hoursLabel: 'Horas semanais por colaborador em tarefas manuais',
      hoursUnit: 'h/semana',
      outputHoursLabel: 'Horas Perdidas / Ano',
      outputHoursUnit: 'horas anuais',
      outputCostLabel: 'Ineficiência de Capital Estimada',
      disclaimer: '* Estimativa calculada com base em 48 semanas úteis/ano e um custo horário empresarial conservador de €22/h.',
      cta: 'Eliminar Este Desperdício no Meu Negócio',
    },
    hero: {
  ...
  en: {
    ...
    calculator: {
      tag: '[OPERATIONAL WASTE CALCULATOR]',
      title: 'SME Friction & Waste Calculator',
      desc: 'Estimate the annual financial toll and hours drained by manual data transfer, redundant tasks, and operational friction.',
      teamSizeLabel: 'Team Size',
      teamSizeUnit: 'employees',
      hoursLabel: 'Weekly hours per employee on manual tasks',
      hoursUnit: 'hrs/week',
      outputHoursLabel: 'Hours Lost Annually',
      outputHoursUnit: 'annual hours',
      outputCostLabel: 'Estimated Capital Inefficiency',
      disclaimer: '* Estimated based on 48 working weeks/year and a conservative enterprise hourly cost of €22/hr.',
      cta: 'Eliminate This Waste In My Business',
    },
    hero: {
